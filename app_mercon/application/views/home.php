...
<head>
  ...
  <style type="text/css">
  #hours{float:left; width:20px; height:25px;}
  #minute{float:left; width:25px; height:25px;}
  #second{float:left; width:10px; height:25px;}
  #jam-digital p{color:#FFF; font-size:100px; text-align:left; margin-top:14px}
  </style>
    ...
    <div class="main-panel">
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="#">Setting Profil</a>
      ...
      <div class="panel-header">
        <div class="header text-center">
          <h2 class="title">Aplikasi Mesin Kasir Cafe Doel</h2>
        </div>
      </div>
      <div class="content">
        <div class="row">
